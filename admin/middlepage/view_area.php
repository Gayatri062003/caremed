        ...
        <div class="card card-statistics h-100"> 
          <div class="card-body">
           <div class="d-block d-md-flex justify-content-between">
              <div class="d-block">
                <h5 class="card-title pb-0 border-0">View Area</h5>
              </div>
               </div>
             </div>
              ...
              <table class="table center-aligned-table mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="">insert</a> | <a href="index.php?page=area_action&id=<?php echo $row['Area_ID']; ?>">Delete</a></td>
                  </tr>
                  <?php } ?>
