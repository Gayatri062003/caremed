                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php if($row['IsActive']=="1") { ?>Active<?php }else { ?>Inactive<?php } ?></td>
                     <?php $sql1 = mysqli_query($con,"select * from `user_table` "); ?>
                     <td><select>
                       <option value="">==select User==</option>
                       <?php $row1=mysqli_fetch_array($sql1); ?>
                       <option value="<?php echo $row1['User_id']; ?>"><?php echo $row1['first_name']; ?></option>
                     
                     </select></td>
                     <td><a href="index.php?page=emp_to_user&User_id=<?php echo $row1['User_id']; ?>&emid=<?php echo $row['Emp_ID']; ?>">Assgin</a> </td>
